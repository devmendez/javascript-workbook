...
//implement a function that will execute a binary search on the array to find the needle
// your code here

function betterFind(array, needle) {
  //defining start and end indexes
  let startIndex = 0;
  ...
  while (startIndex <= endIndex) {
    ...
    //comparing middle index with target word for a match
    ...
    if (needle < array[midIndex]) {
      ...
      endIndex = midIndex - 1;
      //Target not found. Looping again
    }
  }
  return -1;
}

// Function to see if target found or not
let wasItFound = betterFind(sortedArray, "action");
